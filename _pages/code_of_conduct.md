...
As such, this Code of Conduct applies to all ML4Cryo activities, including but not limited to:
...
The Code of Conduct and guidelines are not an exhaustive rulebook. It is intended to serve as a collaborative and shared set of goals to facilitate mailing list use.
...
1. Be excellent to each other. All users are expected to treat all members of the community with the dignity, respect, and kindness that they themselves would expect. All members share in this responsibility.
2. Be civil and considerate. Assume good faith. Science is complicated and communication via text messaged or email can remove nuance and tone. Remember that others might not share your jargon, may be unfamiliar with what you think is common knowledge, and may not speak English (or another language being used for communication) as a first language.
...
<!-- I am excluding the following subpart, because local and national laws might ban behavior (such as open expressing a different gender identity than the one assigned at birth), that does not violate this Code of Conduct. -->
<!-- as well as further actions or considerations made unlawful by national or local laws, ordinances, or regulations. -->
...
Direct contact: It is always appropriate to email a list member, mention that you believe their behaviour was not appropriate, and if required direct them to this document. Inclusion of the moderation team cryolist-owner@lists.cryolist.org in these communications is encouraged.
...
<!-- Right now we cannot handle investigations. If we extend to in-person events, we should review this and figure out how we can do this. We probably need money for external investigators. -->

<!-- For now, I'd rather make it the moderators committee decision. -->
...
We welcome feedback in any form on this Code of Conduct; If you would like to reach out, please write an email to [ml4cryo@gmail.com](mailto:ml4cryo@gmail.com).
